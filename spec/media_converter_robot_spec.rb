  ...
  describe CF::MediaConverterRobot do
    context "create a media converter robot worker" do
      it "should create media_converter_robot worker for first station in a plain ruby way" do
        ...
        VCR.use_cassette "media_converter_robot/plain/create-worker-in-first-station", :record => :new_episodes do
          line = CF::Line.new("media-line1","Digitization")
          ...
          run = CF::Run.create(line, "media-converter-robot1", [{"url"=> "www.s3.amazon.com/converted/20110518165230/ten.mpg", "to" => "mpg", "audio_quality" => "320", "video_quality" => "3",  "meta_data_text"=>"media"}])
      ...
      it "should create media_converter_robot worker for first station in a plain ruby way without passing station parameter within the syntax" do
        # WebMock.allow_net_connect!
        VCR.use_cassette "media_converter_robot/plain/create-worker-in-plain-ruby-way", :record => :new_episodes do
          line = CF::Line.new("media-line-21","Digitization")
          ...
          run = CF::Run.create(line, "media-converter-robot-21", [{"url"=> "www.s3.amazon.com/converted/20110518165230/ten.mpg", "to" => "mpg", "audio_quality" => "320", "video_quality" => "3",  "meta_data_text"=>"media"}])
      ...
      it "should create media_converter_robot worker for multiple station in a plain ruby way" do
        ...
        VCR.use_cassette "media_converter_robot/block/create-worker-multiple-station", :record => :new_episodes do
          line = CF::Line.create("media-line-41","Digitization") do |l|
          ...
          run = CF::Run.create(line, "media-converter-robot-41", [{"Company" => "Apple", "Website" => "www.apple.com", "url"=> "www.s3.amazon.com/converted/20110518165230/ten.mpg", "to" => "mpg", "audio_quality" => "320", "video_quality" => "3",  "meta_data_text"=>"media"}])
      ...
      it "should create media_converter_robot in block DSL way" do
        ...
        VCR.use_cassette "media_converter_robot/block/create-worker-block-dsl-way", :record => :new_episodes do
          line = CF::Line.create("media-line-52","Digitization") do |l|
            CF::InputFormat.new({:line => l, :name => "url", :required => true, :valid_type => "url"})
            CF::InputFormat.new({:line => l, :name => "to", :required => false, :valid_type => "general"})
            CF::InputFormat.new({:line => l, :name => "audio_quality", :required => false, :valid_type => "general"})
            CF::InputFormat.new({:line => l, :name => "video_quality", :required => false, :valid_type => "general"})
          ...
          run = CF::Run.create(line, "media-converter-robot-52", [{"url"=> "www.s3.amazon.com/converted/20110518165230/ten.mpg", "to" => "mpg", "audio_quality" => "320", "video_quality" => "3",  "meta_data_text"=>"media"}])
