  ...
  context "return lines of a category" do
    xit "should return all the lines of a particular category" do
      VCR.use_cassette "department/lines-of-category", :record => :new_episodes do
        5.times do |i|
          CF::Line.new("Digitize Card #{i}","4dc8ad6572f8be0600000001")
        end
        5.times do |i|
          CF::Line.new("Line Name #{i}","4dc8ad6572f8be0600000006")
        end
        lines_category_1 = CF::Department.get_lines_of_department("4dc8ad6572f8be0600000001")
        lines_category_2 = CF::Department.get_lines_of_department("4dc8ad6572f8be0600000006")
        debugger
