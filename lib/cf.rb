...
require "#{directory}/cf/content_scraping_robot"
require "#{directory}/cf/sentiment_robot"
require "#{directory}/cf/term_extraction_robot"
require "#{directory}/cf/text_appending_robot"
require "#{directory}/cf/mailer_robot"
require "#{directory}/cf/entity_extraction_robot"
require "#{directory}/cf/media_splitting_robot"
require "#{directory}/cf/image_processing_robot"
require "#{directory}/cf/concept_tagging_robot"
require "#{directory}/cf/keyword_matching_robot"
require "#{directory}/cf/text_extraction_robot"